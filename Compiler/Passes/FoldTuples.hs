module Compiler.Passes.FoldTuples (fold_tuples) where
  ...
  fold_tuples_bindings :: [Binding] -> [Binding]
  fold_tuples_bindings = map (\(p, e) -> (fold_tuples_pattern p, fold_tuples_expression e))
  ...
  fold_tuples_expression (E_ITE e1 e2 e3) =
    E_ITE (fold_tuples_expression e1) (fold_tuples_expression e2) (fold_tuples_expression e3)
  fold_tuples_expression (E_Case e1 bs)   =
    E_Case (fold_tuples_expression e1) (fold_tuples_bindings bs)
  ...
  fold_tuples_expression (E_Let bs e)     =
    E_Let (fold_tuples_bindings bs) (fold_tuples_expression e)
